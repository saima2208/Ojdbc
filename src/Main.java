 ...
 */
        String[][] books = {
                {"MacBeth", "Shakespeare",  "500", "2000-06-6"},
                {"Merchant of Vanice", "Shakespeare",  "400", "1999-06-6"},
                {"King Lear", "Shakespeare","300", "2001-06-6"},
                {"Doctor Faustus", "Christofer Marlow", "700", "2002-06-6"}
